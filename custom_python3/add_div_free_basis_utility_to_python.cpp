...
void FiniteCellApplication_AddDivFreeBasisUtilityToPython(pybind11::module& m)
{

    class_<DivFreeBasisUtility, DivFreeBasisUtility::Pointer, QuadratureUtility>
    (m, "DivFreeBasisUtility")
    .def(init<>())
