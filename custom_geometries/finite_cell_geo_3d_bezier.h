...
//    {}
    ...
    {
        return typename Geometry<TPointType>::Pointer( new FiniteCellGeo3dBezier( ThisPoints ) );
    }
...
//        return p_clone;
        ...
        KRATOS_THROW_ERROR(std::logic_error, "FiniteCellGeo3dBezier geometry does not support for Clone", *this)
    }
